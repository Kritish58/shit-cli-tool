...
module.exports = newProjectFunc = (projectName) => {
   exec('cd', (error, stdout, stderr) => {
      ...
      fse.copy(path.join(__dirname, '..', 'source'), newProjectPath, (err) => {
         ...
         console.log();
         console.log(chalk.bold.white('To update all packages to latest dependencies: '));
         ...
         console.log();
         console.log('If you want to check which modules are outdated: ', chalk.bold.yellow('npm outdated '));
         console.log();
         console.log(
