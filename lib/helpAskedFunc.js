...
module.exports = helpAskedFunc = () => {
   ...
   console.log(
      chalk.green('shit create module <module_name>'),
      chalk.white('//'),
      chalk.white('command to create a module')
   );
   ...
   console.log(
      chalk.green('shit create service <service_name> <module_name>'),
      chalk.white('//'),
      chalk.white('command to create a service')
   );
};
